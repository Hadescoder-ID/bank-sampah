 	...
 	<div class="row">
 		<div class="col-sm-12">
			...
			<div class="container">
			  <div class="row">
			    <div class="col-sm">
			     	<button type="button" class="btn btn-primary btnTambahDataKTrx" data-toggle="modal" data-target="#exampleModal" data-zurl="<?= BASEURL; ?>">
 				Tambah Transaksi
 					</button>
			    ...
			    <div class="col-sm">
			    	<form action="<?= BASEURL; ?>/Transaksi/cariTrx" method="post">
 					...
 					<?php
						...
						foreach ($data['trans'] as $trx) : ?>
 						<tr>
 							...
 							<td><?= $trx['total']; ?></td>
 							<td>
 								<a href="<?= BASEURL; ?>/Transaksi/update_transaksi/<?= $trx['id'] ?>" class="badge badge-primary badge-pill tampilModalKUbahTrx" data-toggle="modal" data-target="#exampleModal" data-id="<?= $trx['id'] ?>" data-zurl="<?= BASEURL; ?>">Edit</a>
 								<a href="<?= BASEURL; ?>/Transaksi/hapus_transaksi/<?= $trx['id'] ?>" class="badge badge-danger badge-pill" onclick="return confirm('Hapus data?');">Hapus</a>
 							</td>
 						</tr>
 					<?php endforeach; ?>
 				</tbody>
 	...
 	<div class="modal-dialog" role="document">
 		<div class="modal-content">
 			...
 			<div class="modal-body">
 				<form action="<?= BASEURL; ?> /Transaksi/tambah_transaksi" method="POST" enctype="multipart/form-data">
